				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-2 align-self-center" style="max-width: 199px">
							<div class="logo">
								<a target="_blank" href="https://csc.fi"><img src="/themes/b2drop/apps/core/img/csc.png" alt="CSC+logo" width="199px"></a>
							</div>
						</div>
						...
						<div class="col-md-8" style="flex: 0 0 50%; max-width: 50%">
							<div id="menu">
								<ul>
									...
									<li><a target="_blank" href="https://docs.eudat.eu/b2drop/">USER GUIDE</a></li>
